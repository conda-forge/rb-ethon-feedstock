...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rb-ethon-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7683&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rb-ethon-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rb-ethon` can be installed with:

```
conda install rb-ethon
```

It is possible to list all of the versions of `rb-ethon` available on your platform with:
